...
class Match:
    ...
    def run(self, team1, team2, num_player=1, max_frames=MAX_FRAMES, max_score=3, record_fn=None,
            timeout=1e10, initial_ball_location=[0, 0], initial_ball_velocity=[0, 0], verbose=False):
        ...
        for it in range(max_frames):
            ...
            if t1_can_act:
                if t1_type == 'image':
                    team1_actions_delayed = self._r(team1.act)(team1_state, team1_images, soccer_state['ball'])
                else:
